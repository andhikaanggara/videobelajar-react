      ...
      <div className="max-w-[1242px] w-full px-5 py-7 flex flex-col gap-6">
        ...
        >
          <div className="flex flex-col gap-3">
            <Heading4
              className={"text-textLight-primary font-poppins"}
            >{`Gapai Karier Impianmu sebagai ${product.title}`}</Heading4>
            <BodySmall className={"text-textLight-primary"}>
          ...
          <RatingField
            ...
            className={"text-textLight-secondary"}
          />
        </div>

        {/* frame 1 */}
        <div className="rounded-xl bg-other-primarybg border-other-border border p-4 gap-4 flex flex-col md:max-w-[366px]">
          {/* gapai karier */}
          <div className="flex flex-col gap-3">
            <Heading6
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-2">
                <Heading6 className={"font-semibold text-main-primary text-lg"}>
                  {product.price}
                </Heading6>
            ...
            <BodySmall variant="medium" className={"text-sm text-info-default"}>
          ...
          <div className="flex flex-col gap-3">
            <Heading4 className={"font-semibold text-sm text-textDark-primary"}>
              Kelas Ini Sudah Termasuk
            </Heading4>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-xl bg-other-primarybg border-other-border border p-4 gap-4 flex flex-col">
            <Heading6 className={"font-semibold text-lg"}>Deskripsi</Heading6>
            <p className="font-regular text-sm text-textDark-secondary">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sem
              dignissim mattis tristique elementum. Sit consequat turpis orci
              vel. Diam aenean mattis hac vitae, orci sed pretium pretium. Sit
              ut cursus adipiscing vestibulum, ac nibh. Viverra quis at quis
              suscipit. Fermentum duis duis porttitor amet diam sed ultrices
              condimentum dolor. Imperdiet dictum sapien porta faucibus viverra
              cum massa nec. Eget risus turpis viverra massa ullamcorper.
            </p>
          </div>
          ...
          <div className="rounded-xl bg-other-primarybg border-other-border border p-4 gap-4 flex flex-col">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex justify-between">
                <Heading6 className={"font-semibold text-lg text-main-primary"}>
                  Introduction to ...
                </Heading6>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-textDark-primary">
                ...
                Kami!Ekspansi Pengetahuan Anda dengan Rekomendasi Spesial Kami!
              </p>
            </div>
            {/* card */}
